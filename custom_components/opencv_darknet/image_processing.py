...
class OpenCVImageProcessor(ImageProcessingEntity):
    ...
    def process_image(self, image):
        """Process the image."""
        _LOGGER.debug("Processing a new image")
        ...
        _LOGGER.debug("Scanning through all the bounding boxes and trying to find an output")
        classIds = []
        confidences = []
        boxes = []
        for out in outs:
        ...
        for i in indices:
            ...
            _LOGGER.debug("Found: %s", self.classes[classIds[i]] )
